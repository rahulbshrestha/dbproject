      ...
      <div class="container">      
        <div class="row space-100">
          <div class="col-lg-7 col-md-12 col-xs-12">
            ...
            if ($_POST && isset($_POST['instructor_id']))
            {
              $db = new \PDO('clamv', 'rashresta', '7uAhWd');
              $stmt = $db->prepare("INSERT INTO table (instructor_id) VALUES (?)");
              $result = $stmt->execute(array($_POST['instructor_id']));

              echo $result->rowCount() ? 'Instructor saved in db' : 'Unknown error occured';
            }
            ?>
            </div>
          </div>  
